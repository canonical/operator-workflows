...
| channel | string | 5.12/stable | Actions operator provider as defined [here](https://github.com/charmed-kubernetes/actions-operator#usage) |
...
| integration-test-provider-channel | string | 5.12/stable | Actions operator provider channel as defined [here](https://github.com/charmed-kubernetes/actions-operator#usage) |
